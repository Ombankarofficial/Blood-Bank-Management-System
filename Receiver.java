...
public class Receiver extends JFrame implements ActionListener{
	 ...
	 */
	public Receiver() {
		setTitle("REQUEST FOR BLOOD BAGS");
	...
	public void createGui()
	{
		...
		JButton btnDelete = new JButton("DELETE RECEIVER");
		...
		JButton btnUpdate = new JButton("UPDATE RECEIVER");
		...
		JButton btnAdd = new JButton("ADD  RECEIVER");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(caption.equals("ADD  RECEIVER"))
		{
			AddReceiverInfo di=new AddReceiverInfo();
			di.setVisible(true);
			//JOptionPane.showMessageDialog(this,"DONOR ADDED SUCCESSFULLY");
		}
		else if(caption.equals("UPDATE RECEIVER"))
		{
			UpdateReceiverInfo di=new UpdateReceiverInfo();
			di.setVisible(true);
			//JOptionPane.showMessageDialog(this,"DONOR RECORD UPDATED SUCCESSFULLY");
		}
		else if(caption.equals("DELETE RECEIVER"))
		{
			DeleteReceiverInfo di=new DeleteReceiverInfo();
			di.setVisible(true);

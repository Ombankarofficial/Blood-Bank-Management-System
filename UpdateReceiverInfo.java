...
public class UpdateReceiverInfo extends JFrame implements ActionListener{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					UpdateReceiverInfo frame = new UpdateReceiverInfo();
	...
	public UpdateReceiverInfo() {
		...
		setTitle("UPDATE RECEIVER");
		setIconImage(Toolkit.getDefaultToolkit().getImage(UpdateReceiverInfo.class.getResource("/bb/images/bb4.jpg")));
		createGui();
	}
	...
	public void actionPerformed(ActionEvent e) {
		...
		/*
		 * String bb=(String) combobb.getSelectedItem(); String type=(String)
		 * combotype.getSelectedItem(); String tage=txtage.getText();
		 * if(tage.isEmpty()==false) { age=Integer.parseInt(tage); } else { age=0; }
		 */
		 ...
		 */
					...
					{
					try {
						    String strupdate="update receiverinfo set email=?,address=? where phoneno=?";
			 ...
			 */
				...
				/*
				 * ps.setInt(4,age); ps.setString(5, gendertype); ps.setString(6, bb);
				 * ps.setString(7,type);
				 */
